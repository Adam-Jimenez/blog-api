/**
 * pagination formats the data with a pagination convention before sending it
 *
 */
...
module.exports = (numberOfElementsPerPage = 5) => {
    return (req, res, next) => {
        ...
        res.sendWithPagination = function (data) {
            const formattedData = formatData(data, pageNumber, numberOfElementsPerPage)
